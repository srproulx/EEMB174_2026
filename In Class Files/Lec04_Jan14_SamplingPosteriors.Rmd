...
Now put in the likelihood function here. Remember, we have to combine the data and the proposed parameter. Because we are creating a table of possible parameter values, we want to substitue in each of those parameter values in a row-by-row fashion.
```{r}
